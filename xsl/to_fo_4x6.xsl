...
<xsl:template match="recipes">
  <fo:root>
    <fo:layout-master-set>
      <fo:simple-page-master master-name="recipe-card4x6">
        <fo:region-body column-count="1" reference-orientation="0"
            margin-top="1in" margin-bottom="6in" margin-left="1in"
            margin-right="1.5in" border="0.5pt solid black" padding="6pt"/>
...
<xsl:template match="recipe">
  <fo:page-sequence master-reference="recipe-card4x6">
    <fo:flow flow-name="xsl-region-body" font="10pt Times">

<!-- This was to display title without source
...
<xsl:template match="steps">
  ...
  <fo:list-block padding-top="3pt" provisional-distance-between-starts="5mm">
...
<xsl:template match="group/steps"><!-- parent @name ???? -->
